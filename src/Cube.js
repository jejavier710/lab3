// Group names : Crystal Huang,Alison Sun, Dhriti Goomer,Ria Chockalingam, Jasmine Javier
...
export default class Cube {
  ...
  setImage(gl, imagePath, index) {
    if (index === 0) {
      ...
      if (!uTexture1) console.error("Could not get uniform");
      ...
      img.onload = () => {
        ...
        gl.uniform1i(uTexture1, 1); // note this matches the texture slot number
      };
      img.crossOrigin = "anonymous";
      img.src = imagePath;
    }
  ...
  setUvs() {
    ...
    this.uvs = new Float32Array([
      ...
      // BACK = 4
      0.75, 0.5,  0.75,0.25,  1,0.5,  0.75,0.25,  1,0.5,  1,0.25,
      // BOTTOM
